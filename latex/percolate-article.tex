...
\section{}
%------------------------------------------------
The Percolate package consists of routines for social harnessing and can be directly hacked mainly through four packages: Gmane, Participation, Social, MASS. The text ahead consists of the core features of each of these five python packages.
...
\begin{itemize}
    ...
    \item Predefined synthesis methods for other packages (Gmane, Social, Participation, Percolate).
\end{itemize}
