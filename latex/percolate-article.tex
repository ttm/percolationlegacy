...
\section{}
%------------------------------------------------
The Percolate package consists of routines for social harnessing and depends of four packages: Gmane, Participation, Social, MASS.
...
\begin{itemize}
    ...
    \item Routines to raise ontologies from data, return OWL code and images. (This is a novel and pertinent method of making ontologies to fit data, a somewhat \emph{data-driven ontology making method}).
    ...
    \item Recommendation of resources by both absolute criteria (ranking of users, words, etc.) and by criteria relative to a reference resource (recommend users given a reference post).
